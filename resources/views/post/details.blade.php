...
@section('content')
	...
	<div class="main-container">
		...
		<div class="container">
		<script>console.log("post/details:")</script>
			<div class="row">
				<div class="col-md-12">
						...
						<div class="items-details">
							<div class="row pb-4">
								<div class="items-details-info jobs-details-info col-md-8 col-sm-12 col-xs-12 enable-long-words from-wysiwyg">
									...
									@if(!empty($post->require_skills))
										<!-- require skills -->
										<?php $skills = json_decode($post->require_skills); ?>
										<h5 class="list-title"><strong>{{ t('require skills') }}</strong></h5>
										<div class="tags">
