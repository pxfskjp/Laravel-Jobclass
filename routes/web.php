	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
		...
		Route::group(['namespace' => 'Post'], function ($router) {
			...
			Route::group(['namespace' => 'CreateOrEdit\MultiSteps'], function ($router) {
				...
				Route::get('posts/create/{tmpToken}/invitation', 	'CreateController@invitation');
				Route::post('posts/create/{tmpToken}/finish_post', 	'CreateController@prefinish');
		...
		Route::group(['prefix' => 'ajax'], function ($router) {
			...
			Route::get('countries/admins/skills', 'Ajax\LocationController@getSkills');
